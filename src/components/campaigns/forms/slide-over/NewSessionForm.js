  ...
  const submitHandler = async e => {
    ...
    if (id) {
      dispatch(
        updateSheetResourceStart(
          ...
          id,
          { date, content },
          { slideOver: true, notification: { status: 'success', heading: 'Session Updated', message: `You have successfully updated ${'session name'}.` } }
        )
      );
      return;
    }
    ...
    dispatch(
      createSheetResourceStart(
        ...
        'logs',
        { date, content },
        { slideOver: true, notification: { status: 'success', heading: 'Session Created', message: `You have successfully created ${'session name'}.` } }
      )
    );
  };
